...
window.I18N = {
  en: {
    ...
    /* ── Mi camino (v1.183.0) — the companion screen ── */
    cam_chip: "My path",
    cam_titulo_pre: "My path to",
    cam_elegir: "Make this my path",
    cam_es_tu_camino: "This is your path — open it",
    cam_pendientes: "To do",
    cam_nuevo: "NEW",
    cam_visita_pre: "Since your last visit",
    cam_visita_nuevos: "new or changed requirements",
    cam_visita_retirados: "no longer listed",
    cam_visita_igual: "No changes to your requirements",
    cam_visita_desde: "since",
    cam_ap_cerrada: "Quota closed",
    cam_dias: "days left",
    cam_explorar: "Explore the map",
    cam_abandonar: "Abandon this path",
    cam_abandonar_confirma: "Abandon this path? Your checked items will be deleted.",
    cam_perdido_titulo: "This route is no longer available in Wayfare",
    cam_perdido_sub: "The route you chose no longer appears with your current profile — it may have changed officially, or your profile changed. Explore the map to pick a new path.",
    g_missing: "Missing",
  ...
  es: {
    ...
    /* ── Mi camino (v1.183.0) — la pantalla acompañante ── */
    cam_chip: "Mi camino",
    cam_titulo_pre: "Mi camino a",
    cam_elegir: "Convertirlo en mi camino",
    cam_es_tu_camino: "Es tu camino — ábrelo",
    cam_pendientes: "Por hacer",
    cam_nuevo: "NUEVO",
    cam_visita_pre: "Desde tu última visita",
    cam_visita_nuevos: "requisitos nuevos o cambiados",
    cam_visita_retirados: "ya no aparecen",
    cam_visita_igual: "Sin cambios en tus requisitos",
    cam_visita_desde: "desde el",
    cam_ap_cerrada: "Cupo cerrado",
    cam_dias: "días",
    cam_explorar: "Explorar el mapa",
    cam_abandonar: "Abandonar este camino",
    cam_abandonar_confirma: "¿Abandonar este camino? Tus tareas marcadas se borrarán.",
    cam_perdido_titulo: "Esta vía ya no está disponible en Wayfare",
    cam_perdido_sub: "La ruta que elegiste ya no aparece con tu perfil actual — puede haber cambiado oficialmente, o cambió tu perfil. Explora el mapa para elegir un camino nuevo.",
    g_missing: "Falta",
