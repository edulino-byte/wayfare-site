...
window.I18N = {
  en: {
    ...
    search_label: "Find a destination",
    search_ph: "Type a country…",
    search_empty: "No matches — try another name",
  ...
  es: {
    ...
    search_ph: "Escribe un país…",
    search_empty: "Sin resultados — prueba otro nombre",
