...
function GlobeView({ t, lang, profile, onEditProfile, globeStyle }) {
  ...
  React.useEffect(() => {
    ...
    function capColor(d) {
      ...
      const isSel = selRef.current && d.__id === selRef.current.__id;
      const isHov = hoverRef.current && d.__id === hoverRef.current.__id;
      return statusColor(r ? r.status : "ineligible", isSel ? 0.72 : isHov ? 0.58 : 0.42);
    }
...
function CountryDetail({ t, lang, result }) {
  ...
  } }, /* @__PURE__ */ React.createElement("span", { className: "sw", style: { background: statusColor(result.status, 1) } }), t(statusKey)))), /* @__PURE__ */ React.createElement("div", { className: "sub-label" }, t("g_visas_here")), result.visas.map((v, i) => {
